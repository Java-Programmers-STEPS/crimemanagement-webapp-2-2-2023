...
<hr>
        ...
        <div class="form-group">
            ...
            <input  style="width: 30rem" type="text"class="form-control"name="fullname"id="fullname"placeholder="Eg: camelin Tisaa" >
          </div>
          
            <div class="form-group">
            <label for="inputeditofficers" class="col-sm-2 col-form-label">PEN Number</label><br><br>
           
            <input  style="width: 30rem" type="text"class="form-control"name="pennumber"id="pennumber" placeholder="Eg:125478" >
          </div>
 <div class="form-group">
  ...
  <br><br>
           ...
           <div class="form-group">
            ...
            <input  style="width: 30rem" type="text"class="form-control"name="email"id="email" placeholder="Eg:camelin123@gmail.com" >
          </div>
          
           <div class="form-group">
            <label for="inputeditofficers" class="col-sm-2 col-form-label">Phone Number</label><br><br>
            
            <input  style="width: 30rem" type="text"class="form-control"name="phone"id="phone" placeholder="Eg:97XXXXXX42" >
          </div>
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input  style="width: 30rem" type="password"class="form-control"name="password" id="password"placeholder="Eg: Asd123@" >
          </div>
          
          <div class="form-group">
             <label for="inputeditofficers" class="col-sm-2 col-form-label">Confirm Password</label><br><br>
            
            <input  style="width: 30rem" type="password"class="form-control"name="cpassword"id="cpassword"placeholder="Eg: Asd123@" >
          </div>
